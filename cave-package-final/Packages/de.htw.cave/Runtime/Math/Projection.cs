...
namespace Htw.Cave.Math
{
    public static class Projection
    {
		...
		public static Matrix4x4 Bimber(float[,] homography)
        {
            ...
            mat[0] = homography[0, 0];
            mat[1] = homography[1, 0];
            mat[3] = homography[2, 0];
            mat[4] = homography[0, 1];
            mat[5] = homography[1, 1];
            mat[7] = homography[2, 1];
            mat[10] = 1f - (mat[3] < 0f ? -mat[3] : mat[3]) - (mat[7] < 0f ? -mat[7] : mat[7]);
            mat[12] = homography[0, 2];
            mat[13] = homography[1, 2];
            mat[15] = 1f;
