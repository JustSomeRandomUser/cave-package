...
namespace Htw.Cave.Math
{
    public static class Projection
    {
		...
		public static void HolographicFastPrecompute(Vector3 v1, Vector3 v2, Vector3 v3, ref Vector3 vr, ref Vector3 vu, ref Vector3 vn)
		{
			vr = (v2 - v1).normalized;
			vu = (v3 - v1).normalized;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Matrix4x4 HolographicFast(Vector3 v1, Vector3 v2, Vector3 v3, Vector3 vr, Vector3 vu, Vector3 vn, Vector3 target, float near, float far)
		{
